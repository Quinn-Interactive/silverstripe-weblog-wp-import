...
class ImportController extends Controller
{
    ...
    public function ProcessImport($data, $form)
    {
        ...
        foreach (['Posts', 'Drafts'] as $post_group) {
            foreach ($import->$post_group as $orig) {
                ...
                $dom = SimpleHtmlDom\str_get_html(
                        $content, $lowercase = true, $forceTagsClosed = true, $target_charset = 'UTF-8', $stripRN = false
                );
                ...
                if ($scrape_for_featured_images && !$blog_post->FeaturedImage()->exists()) {
                    ...
                    if ($remote_html && $dom = SimpleHtmlDom\str_get_html(
                            $remote_html, $lowercase = true, $forceTagsClosed = true, $target_charset = 'UTF-8', $stripRN = false
                            )) {
    ...
    public function getImportData()
    {
        ...
        return ArrayData::create([
            ...
            'Drafts' => $data->Posts->filter('Status', 'draft'),
